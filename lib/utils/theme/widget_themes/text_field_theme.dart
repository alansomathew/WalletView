...
class WTextFormFieldTheme {
  ...
  static InputDecorationTheme lightInputDecorationTheme = InputDecorationTheme(
    ...
    labelStyle: const TextStyle()
        .copyWith(fontSize: WSizes.fontSizeMd, color: WColors.black),
    hintStyle: const TextStyle()
        .copyWith(fontSize: WSizes.fontSizeSm, color: WColors.black),
    errorStyle: const TextStyle().copyWith(fontStyle: FontStyle.normal),
    floatingLabelStyle:
        const TextStyle().copyWith(color: WColors.black.withOpacity(0.8)),
  ...
  static InputDecorationTheme darkInputDecorationTheme = InputDecorationTheme(
    ...
    //? constraints: const BoxConstraints.expand(height: WSizes.inputFieldHeight),
    labelStyle: const TextStyle()
        .copyWith(fontSize: WSizes.fontSizeMd, color: WColors.white),
    hintStyle: const TextStyle()
        .copyWith(fontSize: WSizes.fontSizeSm, color: WColors.white),
    floatingLabelStyle:
        const TextStyle().copyWith(color: WColors.white.withOpacity(0.8)),
    border: const OutlineInputBorder().copyWith(
      borderRadius: BorderRadius.circular(WSizes.inputFieldRadius),
